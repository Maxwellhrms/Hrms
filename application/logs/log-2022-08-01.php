...
ERROR - 2022-08-01 00:23:06 --> Query error:  - Invalid query: 
ERROR - 2022-08-01 00:23:21 --> Query error:  - Invalid query: 
ERROR - 2022-08-01 00:26:07 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '@serial_number:=@serial_number+1 as serial_number,mxemp_emp_uan_number,concat(mx' at line 1 - Invalid query: SET @serial_number:=0select @serial_number:=@serial_number+1 as serial_number,mxemp_emp_uan_number,concat(mxemp_emp_fname,' ',mxemp_emp_lname),mxsal_actual_gross,mxsal_pf_pension_cont,mxsal_eps_wages,mxsal_edli_wages,mxsal_pf_comp_cont,mxsal_pf_edli,mxsal_pf_edli, '' as refund_adv from mxsal_m inner join maxwell_employees_info on mxemp_emp_comp_code = mxsal_cmp_id and mxemp_emp_type = mxsal_emp_type and mxemp_emp_id = mxsal_emp_code inner join maxwell_company_master on mxcp_id = mxemp_emp_comp_code inner join maxwell_designation_master on mxdesg_id = mxemp_emp_desg_code inner join maxwell_department_master on mxdpt_id = mxemp_emp_dept_code inner join maxwell_division_master on mxd_id = mxemp_emp_division_code inner join maxwell_branch_master on mxb_id = mxemp_emp_branch_code inner join maxwell_grade_master on mxgrd_id = mxemp_emp_grade_code inner join maxwell_state_master on mxst_id = mxemp_emp_state_code where mxsal_status=1 and mxsal_year_month=202206 and mxsal_cmp_id = 1 and mxsal_emp_type = 4
ERROR - 2022-08-01 00:35:13 --> Severity: error --> Exception: syntax error, unexpected '<' /home/maxwelllogistics/public_html/maxwellhrms/application/views/reports/excelreports/dynamic_paysheet_excellist.php 4
ERROR - 2022-08-01 01:18:44 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'SELECT
                (
                select max(case when mxemp_leave_bal_' at line 1 - Invalid query: select @serial_number:=@serial_number+1 as serial_number,mxemp_emp_uan_number as uan,concat(mxemp_emp_fname,' ',mxemp_emp_lname) as name,mxsal_actual_gross as gross_wages,mxsal_pf_pension_cont as epf_wages,mxsal_eps_wages as eps_wages,mxsal_edli_wages as edli_wages,mxsal_pf_comp_cont as epf_cont_remit,mxsal_pf_edli as eps_cont_remit,mxsal_pf_edli as epf_eps_diff_remit,0 as ncp_days, '' as refund_adv from mxsal_m inner join maxwell_employees_info on mxemp_emp_comp_code = mxsal_cmp_id and mxemp_emp_type = mxsal_emp_type and mxemp_emp_id = mxsal_emp_code inner join maxwell_company_master on mxcp_id = mxemp_emp_comp_code inner join maxwell_designation_master on mxdesg_id = mxemp_emp_desg_code inner join maxwell_department_master on mxdpt_id = mxemp_emp_dept_code inner join maxwell_division_master on mxd_id = mxemp_emp_division_code inner join maxwell_branch_master on mxb_id = mxemp_emp_branch_code inner join maxwell_grade_master on mxgrd_id = mxemp_emp_grade_code inner join maxwell_state_master on mxst_id = mxemp_emp_state_code inner join SELECT
                (
            ...
            GROUP BY EmployeeID) as attendance on  EmployeeID = mxsal_emp_code where mxsal_status=1 and mxsal_year_month=202206 and mxsal_cmp_id = 1 and mxsal_emp_type = 4
ERROR - 2022-08-01 01:19:21 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near 'SELECT
                (
