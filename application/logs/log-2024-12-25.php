...
ERROR - 2024-12-25 14:06:33 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '1,mxsal_total_ded as total_deduction, mxsal_net_sal as net_sal from mxsal_m inne' at line 1 - Invalid query:  select @serial_number:=@serial_number+1 as serial_number,mxsal_year_month as yearmonth,mxsal_emp_code as emp_code,concat(mxemp_emp_fname,' ',mxemp_emp_lname) as name,mxemp_emp_panno as pan,mxemp_emp_uan_number as uan,designation as designation,mxemp_emp_date_of_birth as dob,mxemp_emp_date_of_join as doj,mxemp_emp_resignation_relieving_date as dol,mxsal_actual_basic as basic,mxsal_actual_hra as hra,mxsal_misc_income as misc_income,mxsal_lta_amount as lta_amount,mxsal_mediclaim_amount as mediclaim_amount,mxsal_bonus as bonus,mxsal_incentive_amount as incenti_amount,others as others,others as others,total_sal as total_sal,mxsal_pf_comp_cont as pf,mxsal_esi_comp_cont as esi,mxsal_pt as pt,mxsal_tds_amount as tds,staff advance,others 1,mxsal_total_ded as total_deduction, mxsal_net_sal as net_sal from mxsal_m inner join maxwell_employees_info on mxemp_emp_comp_code = mxsal_cmp_id and mxemp_emp_type = mxsal_emp_type and mxemp_emp_id = mxsal_emp_code inner join maxwell_company_master on mxcp_id = mxemp_emp_comp_code inner join maxwell_designation_master on mxdesg_id = mxemp_emp_desg_code inner join maxwell_department_master on mxdpt_id = mxemp_emp_dept_code inner join maxwell_division_master on mxd_id = mxemp_emp_division_code inner join maxwell_branch_master on mxb_id = mxemp_emp_branch_code inner join maxwell_grade_master on mxgrd_id = mxemp_emp_grade_code inner join maxwell_state_master on mxst_id = mxemp_emp_state_code left join maxwell_esi_reasons on mxesi_rsn_id = mxemp_emp_esi_reason inner join (SELECT
                ...
                GROUP BY EmployeeID) as attendance on  EmployeeID = mxsal_emp_code where mxsal_status=1 and mxsal_year_month=202412 and mxsal_cmp_id = 1
ERROR - 2024-12-25 14:07:17 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '1,mxsal_total_ded as total_deduction, mxsal_net_sal as net_sal from mxsal_m inne' at line 1 - Invalid query:  select @serial_number:=@serial_number+1 as serial_number,mxsal_year_month as yearmonth,mxsal_emp_code as emp_code,concat(mxemp_emp_fname,' ',mxemp_emp_lname) as name,mxemp_emp_panno as pan,mxemp_emp_uan_number as uan,designation as designation,mxemp_emp_date_of_birth as dob,mxemp_emp_date_of_join as doj,mxemp_emp_resignation_relieving_date as dol,mxsal_actual_basic as basic,mxsal_actual_hra as hra,mxsal_misc_income as misc_income,mxsal_lta_amount as lta_amount,mxsal_mediclaim_amount as mediclaim_amount,mxsal_bonus as bonus,mxsal_incentive_amount as incenti_amount,others as others,others as others,total_sal as total_sal,mxsal_pf_comp_cont as pf,mxsal_esi_comp_cont as esi,mxsal_pt as pt,mxsal_tds_amount as tds,staff advance,others 1,mxsal_total_ded as total_deduction, mxsal_net_sal as net_sal from mxsal_m inner join maxwell_employees_info on mxemp_emp_comp_code = mxsal_cmp_id and mxemp_emp_type = mxsal_emp_type and mxemp_emp_id = mxsal_emp_code inner join maxwell_company_master on mxcp_id = mxemp_emp_comp_code inner join maxwell_designation_master on mxdesg_id = mxemp_emp_desg_code inner join maxwell_department_master on mxdpt_id = mxemp_emp_dept_code inner join maxwell_division_master on mxd_id = mxemp_emp_division_code inner join maxwell_branch_master on mxb_id = mxemp_emp_branch_code inner join maxwell_grade_master on mxgrd_id = mxemp_emp_grade_code inner join maxwell_state_master on mxst_id = mxemp_emp_state_code left join maxwell_esi_reasons on mxesi_rsn_id = mxemp_emp_esi_reason inner join (SELECT
                    (
                    select max(case when mxemp_leave_bal_leave_type_shrt_name = 'CL' then mxemp_leave_bal_crnt_bal end) from maxwell_emp_leave_balance where mx_attendance_emp_code = mxemp_leave_bal_emp_id
                    group by mxemp_leave_bal_emp_id) as CurrentCL,
                (select max(case when mxemp_leave_bal_leave_type_shrt_name = 'SL' then mxemp_leave_bal_crnt_bal end) from maxwell_emp_leave_balance where mx_attendance_emp_code = mxemp_leave_bal_emp_id
...
ERROR - 2024-12-25 14:15:19 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ' mxesi_emp_types) > 0' at line 9 - Invalid query: SELECT *
FROM `maxwell_esi_master`
WHERE `mxesi_status` = 1
AND `mxesi_div_id` IS NULL
AND `mxesi_state_id` IS NULL
...
AND `mxesi_affect_to` >= '2024-12-25'
AND FIND_IN_SET(, mxesi_emp_types) > 0
ERROR - 2024-12-25 14:15:38 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ' mxesi_emp_types) > 0' at line 9 - Invalid query: SELECT *
FROM `maxwell_esi_master`
WHERE `mxesi_status` = 1
AND `mxesi_div_id` IS NULL
AND `mxesi_state_id` IS NULL
...
AND `mxesi_affect_to` >= '2024-12-25'
AND FIND_IN_SET(, mxesi_emp_types) > 0
ERROR - 2024-12-25 14:17:06 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ' mxesi_emp_types) > 0' at line 9 - Invalid query: SELECT *
FROM `maxwell_esi_master`
WHERE `mxesi_status` = 1
AND `mxesi_div_id` IS NULL
AND `mxesi_state_id` IS NULL
...
AND `mxesi_affect_to` >= '2024-12-25'
AND FIND_IN_SET(, mxesi_emp_types) > 0
ERROR - 2024-12-25 14:17:28 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ' mxesi_emp_types) > 0' at line 9 - Invalid query: SELECT *
FROM `maxwell_esi_master`
WHERE `mxesi_status` = 1
AND `mxesi_div_id` IS NULL
AND `mxesi_state_id` IS NULL
...
AND `mxesi_affect_to` >= '2024-12-25'
AND FIND_IN_SET(, mxesi_emp_types) > 0
ERROR - 2024-12-25 14:17:45 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ' mxesi_emp_types) > 0' at line 9 - Invalid query: SELECT *
FROM `maxwell_esi_master`
WHERE `mxesi_status` = 1
AND `mxesi_div_id` IS NULL
AND `mxesi_state_id` IS NULL
...
AND `mxesi_affect_to` >= '2024-12-25'
AND FIND_IN_SET(, mxesi_emp_types) > 0
ERROR - 2024-12-25 14:20:06 --> Query error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near '1,mxsal_total_ded as total_deduction, mxsal_net_sal as net_sal from mxsal_m inne' at line 1 - Invalid query:  select @serial_number:=@serial_number+1 as serial_number,mxsal_year_month as yearmonth,mxsal_emp_code as emp_code,concat(mxemp_emp_fname,' ',mxemp_emp_lname) as name,mxemp_emp_panno as pan,mxemp_emp_uan_number as uan,designation as designation,mxemp_emp_date_of_birth as dob,mxemp_emp_date_of_join as doj,mxemp_emp_resignation_relieving_date as dol,mxsal_actual_basic as basic,mxsal_actual_hra as hra,mxsal_misc_income as misc_income,mxsal_lta_amount as lta_amount,mxsal_mediclaim_amount as mediclaim_amount,mxsal_bonus as bonus,mxsal_incentive_amount as incenti_amount,others as others,others as others,total_sal as total_sal,mxsal_pf_comp_cont as pf,mxsal_esi_comp_cont as esi,mxsal_pt as pt,mxsal_tds_amount as tds,staff advance,others 1,mxsal_total_ded as total_deduction, mxsal_net_sal as net_sal from mxsal_m inner join maxwell_employees_info on mxemp_emp_comp_code = mxsal_cmp_id and mxemp_emp_type = mxsal_emp_type and mxemp_emp_id = mxsal_emp_code inner join maxwell_company_master on mxcp_id = mxemp_emp_comp_code inner join maxwell_designation_master on mxdesg_id = mxemp_emp_desg_code inner join maxwell_department_master on mxdpt_id = mxemp_emp_dept_code inner join maxwell_division_master on mxd_id = mxemp_emp_division_code inner join maxwell_branch_master on mxb_id = mxemp_emp_branch_code inner join maxwell_grade_master on mxgrd_id = mxemp_emp_grade_code inner join maxwell_state_master on mxst_id = mxemp_emp_state_code left join maxwell_esi_reasons on mxesi_rsn_id = mxemp_emp_esi_reason inner join (SELECT
                    (
                    select max(case when mxemp_leave_bal_leave_type_shrt_name = 'CL' then mxemp_leave_bal_crnt_bal end) from maxwell_emp_leave_balance where mx_attendance_emp_code = mxemp_leave_bal_emp_id
                    group by mxemp_leave_bal_emp_id) as CurrentCL,
                (select max(case when mxemp_leave_bal_leave_type_shrt_name = 'SL' then mxemp_leave_bal_crnt_bal end) from maxwell_emp_leave_balance where mx_attendance_emp_code = mxemp_leave_bal_emp_id
                ...
                GROUP BY EmployeeID) as attendance on  EmployeeID = mxsal_emp_code where mxsal_status=1 and mxsal_year_month=202412 and mxsal_cmp_id = 1
ERROR - 2024-12-25 20:46:08 --> Query error: Unknown column 'mxemp_emp_comp_code' in 'field list' - Invalid query: SELECT `mxemp_emp_lg_employee_id`, `mxemp_emp_lg_fullname`, `mxemp_emp_lg_password`, `mxemp_emp_lg_role`, `mxemp_emp_lg_desktop_permissions`, `mxemp_emp_lg_id`, `mxemp_emp_google_map`, `mxemp_emp_inbranch`, `mxemp_emp_comp_code`, `mxemp_emp_division_code`, `mxemp_emp_branch_code`, `mxemp_emp_dept_code`, `mxemp_emp_grade_code`, `mxemp_emp_desg_code`, `mxemp_emp_state_code`, `mxemp_emp_custom_branch`
FROM `maxwell_employees_login`
WHERE `mxemp_emp_lg_employee_id` = '888666'
ERROR - 2024-12-25 20:46:11 --> Query error: Unknown column 'mxemp_emp_comp_code' in 'field list' - Invalid query: SELECT `mxemp_emp_lg_employee_id`, `mxemp_emp_lg_fullname`, `mxemp_emp_lg_password`, `mxemp_emp_lg_role`, `mxemp_emp_lg_desktop_permissions`, `mxemp_emp_lg_id`, `mxemp_emp_google_map`, `mxemp_emp_inbranch`, `mxemp_emp_comp_code`, `mxemp_emp_division_code`, `mxemp_emp_branch_code`, `mxemp_emp_dept_code`, `mxemp_emp_grade_code`, `mxemp_emp_desg_code`, `mxemp_emp_state_code`, `mxemp_emp_custom_branch`
FROM `maxwell_employees_login`
WHERE `mxemp_emp_lg_employee_id` = '888666'
ERROR - 2024-12-25 20:46:12 --> Query error: Unknown column 'mxemp_emp_comp_code' in 'field list' - Invalid query: SELECT `mxemp_emp_lg_employee_id`, `mxemp_emp_lg_fullname`, `mxemp_emp_lg_password`, `mxemp_emp_lg_role`, `mxemp_emp_lg_desktop_permissions`, `mxemp_emp_lg_id`, `mxemp_emp_google_map`, `mxemp_emp_inbranch`, `mxemp_emp_comp_code`, `mxemp_emp_division_code`, `mxemp_emp_branch_code`, `mxemp_emp_dept_code`, `mxemp_emp_grade_code`, `mxemp_emp_desg_code`, `mxemp_emp_state_code`, `mxemp_emp_custom_branch`
FROM `maxwell_employees_login`
WHERE `mxemp_emp_lg_employee_id` = '888666'
ERROR - 2024-12-25 20:46:12 --> Query error: Unknown column 'mxemp_emp_comp_code' in 'field list' - Invalid query: SELECT `mxemp_emp_lg_employee_id`, `mxemp_emp_lg_fullname`, `mxemp_emp_lg_password`, `mxemp_emp_lg_role`, `mxemp_emp_lg_desktop_permissions`, `mxemp_emp_lg_id`, `mxemp_emp_google_map`, `mxemp_emp_inbranch`, `mxemp_emp_comp_code`, `mxemp_emp_division_code`, `mxemp_emp_branch_code`, `mxemp_emp_dept_code`, `mxemp_emp_grade_code`, `mxemp_emp_desg_code`, `mxemp_emp_state_code`, `mxemp_emp_custom_branch`
FROM `maxwell_employees_login`
