...
ERROR - 2025-08-18 19:09:10 --> Query error: Table 'maxwellhrms_hr.maxwell_attendance_1970_01' doesn't exist - Invalid query: SELECT
     (
    ...
    GROUP BY EmployeeID
ERROR - 2025-08-18 19:09:21 --> Query error: Table 'maxwellhrms_hr.maxwell_attendance_1970_01' doesn't exist - Invalid query: SELECT
     (
     select max(case when mxemp_leave_bal_leave_type_shrt_name = 'CL' then mxemp_leave_bal_crnt_bal end) from maxwell_emp_leave_balance where mx_attendance_emp_code = mxemp_leave_bal_emp_id
     group by mxemp_leave_bal_emp_id) as CurrentCL,
    (select max(case when mxemp_leave_bal_leave_type_shrt_name = 'SL' then mxemp_leave_bal_crnt_bal end) from maxwell_emp_leave_balance where mx_attendance_emp_code = mxemp_leave_bal_emp_id
    ...
    INNER JOIN maxwell_employees_info on mxemp_emp_id = mx_attendance_emp_code
     where mx_attendance_emp_code = 'M1143'
    GROUP BY EmployeeID
ERROR - 2025-08-18 22:19:36 --> Severity: error --> Exception: syntax error, unexpected ')', expecting ',' or ';' /home/maxwellhrms/public_html/application/views/loan/loanhistory.php 143
ERROR - 2025-08-18 22:20:11 --> Severity: error --> Exception: syntax error, unexpected ')', expecting ',' or ';' /home/maxwellhrms/public_html/application/views/loan/loanhistory.php 143
