<?php echo $controller1->mastersfilters_paystructure($ym='Y',$cmp='Y',$div='Y',$stateid='Y',$branch='Y',$emplid='N',$grade='N',$empjoin='N',$categ='N',$day='N',$from ='N',$to ='N',$emp_type='N',$is_quaterly='Y'); ?>
<!--  7 variables -->
...
$("form#commonform").submit(function(e) {
        ...
        try{
            ...
            if(is_finanical){
                ...
                var mnth = $("#quaterly_month_year").val();
                if (mnth == 0 || mnth == "") {
                    $("#quaterly_month_year").focus();
                    $('#attndquatererror').html("Please Select Quaterly");
                    return false;
                } else {
                    $('#attndquatererror').html("");
                }
            }else{
            ...
            $.ajax({
                ...
                type: "post",
                async: false,
                data: {'month_year': month_year,'companyid': company_id, 'divisonid': div_id,'stateid':state_id,'branchid':branch_id,'employeeid':empid,'filter':'1','day':day,'is_finanical':is_finanical, 'is_quaterly':is_quaterly},
