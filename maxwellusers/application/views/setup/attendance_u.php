            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title">Attendance Regularation Under You</h3>
								<ul class="breadcrumb">
					...
					<div class="col-sm-6 col-md-3"> 
						...
						<div class="col-sm-6 col-md-3"> 
							<div class="form-group form-focus select-focus">
								...
								<option value="2" data-select2-id="39">RELOCATION </option></select>
...
//employeecode=&month=1&year=2025&day=03&company=0&divison=0&state=0&branch=0
	var mainurl = baseurl+'getemployeeattendancehistory_u';
$.ajax({
    url: mainurl,
    type: 'get',
    data: {employeecode : emp, month : mnth, year : year,day : day, company:esi_company_id, divison:esi_div_id, state:esi_state_id, branch:esi_branch_id},
