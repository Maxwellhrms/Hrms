            ...
            <div class="page-wrapper">
				<div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">pay_slip</h3>
							</div>
						</div>
					</div>
					<!-- /Page Header -->
													...
													<div class="row">
														...
														<div class="col-md-6">
                        				                    <div class="form-group form-focus select-focus">
                        				                        <label> Date</label>
                                                            	<input type="month" class="form-control datetimepicker11" name="attendance" id="attendance" autocomplete="off" required >
...
function filterattnd123(){
	...
	$.ajax({
        url: baseurl + "pay_slipajax_get_data",
        type: "post",
        async: false,
