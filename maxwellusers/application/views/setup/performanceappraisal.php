...
e.preventDefault();  
var empx = '<?php echo $this->session->userdata('session_loginperson_id') ?>';
/*if(empx == '888666'){
...
if(filename ==""){
  ...
  var mainurl = baseurl+'saveappraisal';
...
$.ajax({
 ...
 $('#designation').change(function(e) {
        ...
        if(department == ''){
        	alert("Please Select Departement1");
        	return false;
        }
        $.ajax({
		    url: baseurl+'performanceappraisal/fileterthedata1',
		    type: 'POST',
...
function filterdetails(){
        ...
        /*if(empx == '888666'){
            ...
            if(department == ''){
            	alert("Please Select Departement2");
            	return false;
            }
        }*/
        $.ajax({
		    url: baseurl+'fileterthedata2',
		    type: 'get',
