$(document).ready(function() {
	...
	if($('.select').length > 0) {
		...
		// 	width: '100%'
		// });
		// $(function() {$('.select').select2({width: '100%'});})
		$('.select').select2({
...
$(document).ready(function() {
  $('tr:not(.headers)').hide(1000);

  $('tr.headers').dblclick(function() {
    $(this).find('span').text(function(_, value) {
      return value == '-' ? '+' : '-'
    });
    
    $(this).nextUntil('tr.headers').slideToggle(100, function() {});
  });
});
...
var users = '',
    ...
    CKEDITOR.replace('desc', {
      ...
      toolbar: [
        ...
        { name: 'links', items: [ 'Link', 'Unlink','JustifyLeft','JustifyCenter', 'JustifyRight', 'JustifyBlock','NumberedList', 'BulletedList', '-', 'Outdent', 'Indent', '-', 'Blockquote' ] },
